...
label_edad.pack()
entry_edad = tk.Entry(root, bg="#424242", fg="white")
entry_edad.pack()

label_raza = tk.Label(root, text="Raza:", font="Times", fg='white')
label_raza['bg']="#383838"
label_raza.pack()
entry_raza = tk.Entry(root, bg="#424242", fg="white")
entry_raza.pack()

label_peso = tk.Label(root, text="Peso:", font="Times", fg= 'white')
label_peso['bg']="#383838"
label_peso.pack()
entry_peso = tk.Entry(root, bg="#424242", fg="white")
entry_peso.pack()
